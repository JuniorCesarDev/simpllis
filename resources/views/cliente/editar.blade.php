                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('cliente.update',['id' => $editar->id])}}" method="post">
                            ...
                            <label for="exampleInputEmail1" class="form-label">Contato</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="contato" value="{{ $editar->contato }}">
                            </div>
                            <button type="submit" class="btn btn-success" onclick="botao()" style="float:right">Editar</button>
